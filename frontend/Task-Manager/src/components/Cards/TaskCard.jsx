...
const TaskCard = ({title, description, priority, projectName, domain, status, progress, createdAt, dueDate, assignedTo, attachmentCount, completedTodoCount, todoChecklist, onClick, onContextMenu}) => {
    ...
    >
       ...
       <div className='px-4 '>
        <div className='flex items-center justify-between my-1 gap-2'>
            ...
            <div>
                <label className="text-xs text-gray-500">Projct Name</label>
                <p className='text-[13px] font-medium text-gray-900'> {projectName}</p>
            </div>
            <div>
                <label className="text-xs text-gray-500">Domain</label>
                <p className='text-[13px] font-medium text-gray-900'> {domain}</p>
            </div>
        </div>
